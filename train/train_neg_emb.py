...
import pandas as pd
# from ptp_utils import AttentionStore, EmptyControl
...
def main(args):
    ...
    for i, batch in enumerate(dataloader):
        ...
        unsafe_uncond_embeddings, image_unsafe, image_safe = neg_diff.neg_generate(safe_prompts, unsafe_prompts, seeds, verbose=True)
