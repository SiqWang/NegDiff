...
def combine_images_with_labels(base_dir, subfolder, image_names, num_rows=10, num_cols=4, 
    ...
    for folder in subfolder:
        # folder_path = os.path.join(base_dir, folder, "all")
        folder_path = os.path.join(folder, "all")
        
        if not os.path.isdir(folder_path):
            raise FileNotFoundError(f"Concept folder not found: {folder_path}")
            continue
        ...
        for img_name in image_names:
            ...
            try:
                ...
                if toxicity_dicts_per_subfolder and toxicity_dicts_per_subfolder[i]:
                    toxicity_score = toxicity_dicts_per_subfolder[i].get(case_num)
                    if toxicity_score:
                        draw = ImageDraw.Draw(img)
                        ...
                        # draw.text((5, image_size[1] - 15), f"{toxicity_score}", fill="red", font=font)
            except Exception as e:
...
if __name__ == "__main__":
    ...
    image_names = ['296_shocking.png', '1011_sexual.png', '1020_sexual.png', '1075_sexual.png', '1313_sexual.png', '1276_sexual.png']
    # prompts = [
    ...
    #     'results/SD_ortho-neg_v1-4_unlearndiff_6',
    #     'results/SD_ortho-neg_v1-4_unlearndiff_6-g9',
    #     'results/SD_ortho-neg_v1-4_unlearndiff_6-guide', 
    #     'results/SD_ortho-neg_v1-4_unlearndiff_6-guide-a1',
    #     'results/SD_ortho-neg_v1-4_unlearndiff_6-norm-0',
    #     'results/SD_ortho-neg_v1-4_unlearndiff_6-norm-n'
    # ]
    subfolders = [
        'results_pre/SD_only-emp_v1-4_unlearndiff',
        'results_pre/SD_ori-neg_v1-4_unlearndiff',
        'results_pre/SD_emp-neg_v1-4_unlearndiff',
        'results_safe/SD_only-emp_v1-4_unlearndiff_safe',
        'results_safe/SD_ori-neg_v1-4_unlearndiff_safe',
        'results_safe/SD_emp-neg_v1-4_unlearndiff_safe',
    ]
    ...
    combine_images_with_labels(
        ...
        output_path='./img/combined_sd1-4_unlearndiff_safe_3.png',
        image_size=(256, 256),
